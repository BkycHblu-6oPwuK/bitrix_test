...
<section class="who-area-are pad-90" id="about_us">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="about-bg">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/assets/sha/img/about/o_nas_text_block.jpg" alt=""/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/sha/img/team/team1.jpg" alt=""/>
                        <div class="team-text">
                            <h4>Привет всем!</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/sha/img/team/team2.jpg" alt=""/>
                        <div class="team-text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/sha/img/team/team3.jpg" alt=""/>
                        <div class="team-text">
                            <h4>Привет!</h4>
